...
export const resources: Resource[] = [
  ...
  { id: "r4", title: "Normativa vigente aplicable a construcción offsite", description: "Compilado de referencias regulatorias relevantes para el diseno y aprobación de soluciones industrializadas.", type: "Normativa", format: "PDF", weight: "2.1 MB", date: "2026-02-20" },
...
export const events: CCIEvent[] = [
  ...
  { id: "e4", title: "Tour de planta: industrialización en acero liviano", date: "2026-06-26", location: "Región Metropolitana", modality: "Presencial", description: "Visita guíada a planta de socio industrializador con recorrido por la linea de producción." },
];
