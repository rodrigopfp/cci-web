...
// CCI Data, capítulo de la respuesta (/data#cap5). En producción, Caddy responde un 301
...
export default function EvidenciaRedirect() {
  return (
    <>
      <meta httpEquiv="refresh" content="0; url=/data/#cap5" />
      <section className="container-cci py-24 text-center">
        ...
        <p className="mt-4">
          <Link href="/data/#cap5" className="btn-primary">Ir a la evidencia en CCI Data</Link>
        </p>
      </section>
    </>
  );
