...
export const FUENTES: Record<string, DataSource> = {
  ...
  "minvu-398": {
    ...
    url: "https://catalogo.minvu.cl/cgi-bin/koha/opac-detail.pl?biblionumber=25850",
    publicationDate: "2025-12-01",
    accessedAt: ACCESSED_VIT,
    documentType: "informe",
    geography: "Chile",
    notes:
      "Publicación oficial N°398, dic 2025, 116 págs. Corte de sus cifras: nov 2025. La licencia permite reproducción parcial citando la fuente, con fines investigativos o académicos y sin uso comercial.",
  },
  "ditec-matta": {
    id: "ditec-matta",
    ...
    url: "https://www.minvu.gob.cl/wp-content/uploads/2026/06/Presentacion-Seminario-VIT-2026-DITEC-Gabriela-Matta.pdf",
  ...
  "ditec-jara": {
    ...
    url: "https://www.minvu.gob.cl/wp-content/uploads/2026/06/Presentacion-Seminario-VIT-2026-DITEC-Susana-Jara.pdf",
    publicationDate: "2026-05-29",
    accessedAt: ACCESSED_VIT,
    documentType: "comunicado",
    geography: "Chile",
  ...
  "ditec-soto": {
    ...
    url: "https://www.minvu.gob.cl/wp-content/uploads/2026/06/Presentacion-Seminario-VIT-2026-DITEC-Marcelo-Soto.pdf",
    publicationDate: "2026-05-29",
    accessedAt: ACCESSED_VIT,
    documentType: "comunicado",
    geography: "Chile",
  ...
  "ditec-calderon": {
    ...
    url: "https://www.minvu.gob.cl/wp-content/uploads/2026/06/Presentacion-Seminario-VIT-2026-DITEC-Jorge-Calderon.pdf",
    publicationDate: "2026-05-29",
    accessedAt: ACCESSED_VIT,
    documentType: "comunicado",
    geography: "Chile",
  ...
  "res52-levantamiento": {
    ...
    url: "https://www.minvu.gob.cl/wp-content/uploads/2026/06/Presentacion-Seminario-VIT-2026-Tecnofast-TecnoPanel-Jorge-Martinez.pdf",
    publicationDate: "2026-05-29",
    accessedAt: ACCESSED_VIT,
    documentType: "otro",
    geography: "Chile",
  ...
  "circular-023": {
    ...
    geography: "Chile",
    notes:
      "Circular N°023, Subsecretaría de Vivienda y Urbanismo, 16 de mayo de 2025. Documento oficial; sin URL pública estable a la fecha de corte. 9 págs. + 4 anexos.",
  },
  "minvu-ci-web": {
    id: "minvu-ci-web",
